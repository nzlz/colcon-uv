...
"""
            ...
            self.assertTrue((temp_path / "install" / "share" / "test_package" / "launch" / "launch" / "test.launch.py").exists())
            self.assertTrue((temp_path / "install" / "share" / "test_package" / "config.yaml").exists())
...
"""
    ...
    def test_create_environment_hooks(self, mock_create_hook, mock_create_hooks, mock_create_scripts):
